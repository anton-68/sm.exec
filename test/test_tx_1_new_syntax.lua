...
default_fsm = sm.new_fsm("sip_ua", "mealy")
fsm:add_node("1", "initial")
fsm:add_node("2", "joint")
fsm:add_node("3", "final")
fsm:add_event(0, "0", default)
fsm:add_event(1, "1", regular)
fsm:add_event(2, "2", regular)
fsm:add_transition("1", "1", , "2", "check_neighbours")
